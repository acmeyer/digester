...
function TextInput({ name, label, ...props }: TextInputProps) {
  return (
    <>
      ...
      <div className="mt-2">
        <div className="flex bg-white rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 dark:bg-white/5 dark:ring-white/10">
          <input
            id={name}
            name={name}
            type="text"
